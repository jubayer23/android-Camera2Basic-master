...
public class Camera2BasicFragment extends Fragment
        implements View.OnClickListener, ActivityCompat.OnRequestPermissionsResultCallback, SeekBar.OnSeekBarChangeListener {
           ...
           // Log.d("DEBUG", "its here 3");
            switch (mState) {
                ...
                case STATE_WAITING_LOCK: {
                    Log.d("DEBUG", "its here 4");
                    Integer afState = result.get(CaptureResult.CONTROL_AF_STATE);
                    Log.d("DEBUG", "its here 4 " + afState);
                    if (afState == null) {
                        Log.d("DEBUG", "its here 4 1");
                        captureStillPicture();
                    } else if (CaptureResult.CONTROL_AF_STATE_FOCUSED_LOCKED == afState ||
                            CaptureResult.CONTROL_AF_STATE_NOT_FOCUSED_LOCKED == afState ) {
                        Log.d("DEBUG", "its here 4 2");
                        // CONTROL_AE_STATE can be null on some devices
                        Integer aeState = result.get(CaptureResult.CONTROL_AE_STATE);
                        if (aeState == null ||
                                aeState == CaptureResult.CONTROL_AE_STATE_CONVERGED) {
                            Log.d("DEBUG", "its here 4 3");
                            mState = STATE_PICTURE_TAKEN;
                            captureStillPicture();
                        } else {
                            Log.d("DEBUG", "its here 4 4");
    ...
    //private TextView textISO, textFOCUS, textSS;
    private SeekBar seekBar_iso, seekBar_Ss, seekBar_focus;
    private TextView tv_iso, tv_ss, tv_focus;
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        seekBar_iso  = (SeekBar) view.findViewById(R.id.seekbar_iso);
        seekBar_iso.setMax(15000);
        seekBar_iso.setProgress(200);
        seekBar_iso.setOnSeekBarChangeListener(this);

        seekBar_Ss = (SeekBar) view.findViewById(R.id.seekbar_ss);
        seekBar_Ss.setMax(234315036);
        seekBar_Ss.setProgress(117152760);
        seekBar_Ss.setOnSeekBarChangeListener(this);

        seekBar_focus = (SeekBar) view.findViewById(R.id.seekbar_focus);
        seekBar_focus.setMax(100);
        seekBar_focus.setProgress(0);
        seekBar_focus.setOnSeekBarChangeListener(this);

        tv_iso = view.findViewById(R.id.tv_iso);
    ...
    public void createCameraPreviewSession_Ss() {
        try {
            //mPreviewRequestBuilder.set(CaptureRequest.COLOR_CORRECTION_GAINS, colorTemperature(seekWb));
            mPreviewRequestBuilder.set(CaptureRequest.SENSOR_EXPOSURE_TIME, seekSs);
            mPreviewRequest = mPreviewRequestBuilder.build();
    ...
    private void lockFocus() {
        try {
            ...
            //mPreviewRequestBuilder.set(CaptureRequest.CONTROL_AF_MODE, CaptureRequest.CONTROL_AF_STATE_FOCUSED_LOCKED);

           // mPreviewRequestBuilder.set(CaptureRequest.CONTROL_AWB_MODE, CaptureRequest.CONTROL_AWB_STATE_LOCKED );
            // mPreviewRequestBuilder.set(CaptureRequest.CONTROL_AE_MODE, CaptureRequest.CONTROL_AE_STATE_LOCKED);
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        switch (seekBar.getId()) {
            case R.id.seekbar_focus:
                seekFocus = progress/10.0f;
                tv_focus.setText(""+seekFocus);
